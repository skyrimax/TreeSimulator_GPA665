...
int main()
{
	...
	Tree tree(1, 0.5, 0.5, 0.1, 2, 2, 0.5, 0.5, 0.005, 0.1, 0.1, 2, 2, M_PI_2, M_PI_2,
		45000000000.0, 30000000, 15000000000.0, 15000000, 1000, 0);

	file << tree.simulate(1000, 940, 125, wind, 1, 100, 100);
